...
#    print k.get_max_solar_flux(46.2, 2004, 01, 30)
    # check sun rise/set on Jan 1 in Mosman, Australia
    rise_ut, set_ut = sun.sunRiseSet(2009,1,1,150,-33)
    utc_offset = 10
    rise = rise_ut + utc_offset
    set = set_ut + utc_offset
    print "Mosman 1/1/2009 Sun Rise %d:%d, Set %d:%d" \
            % (math.floor(rise), math.floor((rise % 1) * 60),
            math.floor(set), math.floor((set % 1) * 60))
