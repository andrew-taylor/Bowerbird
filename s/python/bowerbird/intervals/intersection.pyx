...
cdef inline double imax2(double a, double b):
    if b > a: return b
    return a

cdef inline double imax3(double a, double b, double c):
    if b > a: 
        if c > b:
            return c
        return b
...
cdef inline double imin3(double a, double b, double c):
    if b < a: 
        if c < b:
            return c
        return b
...
cdef inline double imin2(double a, double b):
    if b < a: return b
    return a
...
cdef class IntervalNode:
    ...
    ## 
    ## def neighbors(self, Interval f, int n=1, double max_dist=2500):
    ##     cdef list neighbors = []
    ## 
...
cdef class Interval:
    ...
    def __init__(self, double start, double end, object value=None, object strand=None ):
